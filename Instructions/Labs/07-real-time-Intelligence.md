...
1. 选择“**下一步**”，等待创建源和事件流，然后选择“**打开事件流**”。 事件流将在设计画布上显示**股票**源和 **stock-data-stream**：
...
1. 在“**选择或创建目标表**”窗格中，创建一个名为 `stock` 的新表。 然后在“**配置数据源**”窗格中，选择工作区和**股票数据**事件流并命名该连接`stock-data`。
...
1. 在左侧菜单栏中，选择“**实时**”中心，然后查看“**我的数据流**”页。 应列出**股票**表和 **stock-data-stream** 流。

   ![实时中心“我的数据流”页的屏幕截图。](./Images/my-data-streams.png)

1. 在 **stock-data-stream** 流的 **...** 菜单中，选择“**打开事件流**”。
