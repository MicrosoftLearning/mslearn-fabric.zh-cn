...
7. 在表视觉对象的“**可视化效果**”窗格中，从“**列**”井中选择向下箭头，然后选择“**为此视觉对象重命名**”。
...
6. 要从表视觉对象中删除度量值，请在“**可视化效果**”窗格的“**列**”井中，对“**已装运的销售额**”字段按 **X**。
...
6. 选择新的表视觉对象，然后在“**可视化效果**”窗格的“**列**”井中，删除“**订单年份**”字段。

    ![](Images/work-with-model-relationships-image42.png)

7. 在“数据”窗格中，展开以打开 Ship Date 表 。

8. 要向新的表视觉对象添加新字段，请从**装运日期**表中将“**装运年份**”字段拖到“**销售额**”字段上方的“**列**”井中。
